    ...
    if (showDialogfrutasverduras){
        Dialog(onDismissRequest = {
            ...
            Card(
                ...
                Column() {
                    androidx.compose.material.Text(text = tituloDialogo,
                        style = TextStyle(
                    ...
                    androidx.compose.material.Text(text = textoDialogo, style = TextStyle(fontSize = 15.sp),
                        modifier = Modifier
                            .padding(8.dp)
                            .width(350.dp)
                    )
                ...
                Row() {
                    TextButton(onClick = {
                        ...
                        androidx.compose.material.Text("Cancelar")
                    }
                    TextButton(onClick = {
                        showDialogfrutasverduras = false
                        ...
                        androidx.compose.material.Text("Comprar")
                    }
                    ...
                    Box {
                        Row {
                            TextButton(onClick = {
                                ...
                                androidx.compose.material.Text("Ubicacion")
                            }
                            TextButton(onClick = {
                                showDialogfrutasverduras = true
                            }) {
                                androidx.compose.material.Text("Detalles")
                            }
